...
hl.bind(mod .. " + T", function()
    hl.dispatch(hl.dsp.exec_cmd([[ hyprctl clients -j | jq -e 'any(.[]; .initialClass == "brave-jellyfin.bush.home.arpa__-Default")' >/dev/null || fanos-launch-webapp 'http://jellyfin.bush.home.arpa:8097/#/home' ]]))
