...
hl.bind(mod .. " + T", hl.dsp.workspace.toggle_special({ workspace = "special:tokyo-music" }))
hl.bind(mod .. " + SHIFT + T", hl.dsp.window.move({ workspace = "special:tokyo-music", follow = false }))
